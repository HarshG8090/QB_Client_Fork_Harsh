    ...
    <>
      ...
      <section className='banner overflow-hidden'>
        <div className="container-fluid">
          <div className="row">
            <div className='col-md-12  text-md-start banner-text'>
              <h4 className='fs-1 banner-head'>Donate Blood Save life</h4>
              <p className='  banner-p text-lg-start text-md-start fs-md-4 d-md-inline'> Your Blood can bring smile in other <br/>Personal Face</p>
            </div>
          </div>
        </div>
      </section>
  ...
  <div className="container">
    <div className="row">
      ...
      <section className=' overflow-hidden'>
        <div className="container-fluid">
          <div className="row ">
            {/* <div className='col-lg-5 col-md-6 px-5  mb-3 mtb'>
              <img src={Banner} alt="banner" className='img-fluid img-banner-2 mx-auto px-3' />
            </div> */}
            <div className='align-center px-5 py-4'>
            <h3 className='about-head text-center pb-4'>Who we are ?</h3>
